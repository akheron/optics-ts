...
export interface Lens<S, T extends OpticParams, A> {
  ...
  path<K>(path: K): Lens<S, DescendNextParams<T, A, K>, DescendPath<A, K>>
...
export interface Prism<S, T extends OpticParams, A> {
  ...
  path<K>(path: K): Prism<S, DescendNextParams<T, A, K>, DescendPath<A, K>>
...
export interface Traversal<S, T extends OpticParams, A> {
  ...
  path<K>(path: K): Traversal<S, DescendNextParams<T, A, K>, DescendPath<A, K>>
