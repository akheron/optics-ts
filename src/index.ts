...
export interface Equivalence<S, T extends OpticParams, A> {
  ...
  path<K>(
    path: K
  ): Lens<S, NextParams<T, DescendProp<A, K>>, DescendPath<A, K>>;
...
export interface Prism<S, T extends OpticParams, A> {
  ...
  path<K>(
    path: K
  ): Prism<S, NextParams<T, DescendProp<A, K>>, DescendPath<A, K>>;
...
export interface Traversal<S, T extends OpticParams, A> {
  ...
  prop<K extends keyof A>(
    key: K
  ): Traversal<S, NextParams<T, Prop<A, K>>, A[K]>;

  path<K>(
    path: K
  ): Traversal<S, NextParams<T, DescendProp<A, K>>, DescendPath<A, K>>;
...
export interface Fold<S, A> {
  ...
  path<K>(path: K): Fold<S, DescendPath<A, K>>;
  ...
  index(
    i: number
  ): IfElse<Eq<A, string>, Fold<S, string>, Fold<S, ElemType<A>>>;
