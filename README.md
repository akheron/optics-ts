...
- [API reference](#api-reference)
  ...
  - [Top-level functions](#top-level-functions)
    ...
    - [`remove<S, T, A>(optic: Optic<S, T, A>) => (source: S) => S`](#removes-t-aoptic-optics-t-a--source-s--s)
  ...
  - [Isomorphisms](#isomorphisms)
    ...
    - [`indexed(): Iso<S, _, [number, ElemType<A>][]>`](#indexed-isos-_-number-elemtypea)
  - [Lenses](#lenses)
  ...
  - [`nth<N extends number>(n: N): Lens<S, _, Nth<A, N>>`](#nthn-extends-numbern-n-lenss-_-ntha-n)
    ...
    - [`partsOf(traversal: Traversal<A, _, B>): Lens<S, _, B[]>`](#partsoftraversal-traversala-_-b-lenss-_-b)
    - [`partsOf(makeTraversal: (o: Optic<A>) => Traversal<A, _, B>): Lens<S, _, B[]>`](#partsofmaketraversal-o-optica--traversala-_-b-lenss-_-b)
    - [`reread(fn: (value: A) => A): Lens<S, _, A>`](#rereadfn-value-a--a-lenss-_-a)
    - [`rewrite(fn: (value: A) => A): Lens<S, _, A>`](#rewritefn-value-a--a-lenss-_-a)
  - [Prisms](#prisms)
  ...
  - [Setters](#setters)
    - [`prependTo(): Setter<S, _, ElemType<A>>`](#prependto-setters-_-elemtypea)
    - [`appendTo(): Setter<S, _, ElemType<A>>`](#appendto-setters-_-elemtypea)
  - [Composing](#composing)
